    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-8">
        ...
        <div class="relative py-12 px-8 md:py-20 md:px-12">
          ...
          <!-- Dark box -->
          <div class="absolute inset-0 -z-10" aria-hidden="true" style="background-color: #0B0F1F !important;"></div>
